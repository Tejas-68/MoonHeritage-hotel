...
<body class="bg-gray-100">
    ...
    <div class="ml-64 p-8">
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Manage Hotels</h1>
                <p class="text-gray-600">Add, edit or remove hotels</p>
            </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-900"><?php echo escape($hotel['name']); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo $hotel['total_rooms']; ?> rooms</div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-semibold"><?php echo $hotel['star_rating']; ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-900">
                        ...
                        <td class="px-6 py-4">
                            ...
                            ?>
                            <span class="px-3 py-1 text-xs font-semibold rounded-full <?php echo $statusColors[$hotel['status']]; ?>">
                        ...
                        <td class="px-6 py-4 text-sm">
                            ...
                            <button onclick="deleteHotel(<?php echo $hotel['id']; ?>, '<?php echo escape($hotel['name']); ?>')" 
    ...
    <div id="hotelModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div class="p-6 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white">
                <h2 id="modalTitle" class="text-2xl font-bold text-gray-800">Add New Hotel</h2>
                <button onclick="closeModal()" class="text-gray-500 hover:text-gray-700">
                    <i class="fas fa-times text-2xl"></i>
                </button>
            </div>
            
            <form id="hotelForm" class="p-6" enctype="multipart/form-data">
    ...
    <script>
        ...
        function editHotel(hotel) {
            ...
            document.getElementById('short_description').value = hotel.short_description;
            ...
            document.getElementById('original_price').value = hotel.original_price || '';
            document.getElementById('star_rating').value = hotel.star_rating;
            document.getElementById('total_rooms').value = hotel.total_rooms;
            document.getElementById('featured').value = hotel.featured;
